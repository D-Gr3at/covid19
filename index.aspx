<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="index.aspx.vb" Inherits="corona.WebForm1" %>
                ...
                <div class="d-flex justify-content-center">
                    <span class="text-center">Powered by<br>
                        <a href="https://web.facebook.com/ndcnigeria/">
                            <img
                                src="img/ndc-clinic.jpeg" class="img-fluid" width="70"
                                height="70"></a></span>
                </div>
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <b>This is a COVID-19 self assessment tool that
                                <br>
                                was calibrated based on WHO
                                guidelines.<br>
                                It is not a diagnostic tool.</b>
                            <div class="form-group">
                                ...
                                <select name="DropDownList1"
                                    ...
                                    id="DropDownList1" class="form-control" runat="server" onserverclick="select_language">
